...
--
-- Host: 127.0.0.1    Database: photosi
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `ADDRESSID` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `ordersdetail` VALUES (1,0,3,0);
...
--
-- Dumping routines for database 'photosi'
--
...
-- Dump completed on 2022-08-02 11:15:04
